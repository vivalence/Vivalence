...
A mode is just JavaScript and Svelte — no magic - but they provide everything an application needs. Modes are the building blocks - datasets, domain logic, services, interfaces are all properties of modes - and you compose them into daemons. Vivalence's modal architecture turns apps into evolving systems, capable of growing and changing to fit your needs when they arise.

→ **[awesome-vivalence](https://github.com/vivalence/awesome-vivalence)** — the current registry. PRs welcome.
