...
<script>
  ...
  import PanelA from "./panels/a.svelte";
  import PanelB from "./panels/b.svelte";
  import PanelC from "./panels/c.svelte";
  import PanelG from "./panels/g.svelte";
  import PanelH from "./panels/h.svelte";
  import InspectLighthouse from "./panels/inspectors/lighthouse.svelte";
  import InspectQuarters from "./panels/inspectors/quarters.svelte";
  import InspectBridge from "./panels/inspectors/bridge.svelte";
  import InspectThread from "./panels/inspectors/thread.svelte";
  import BoneShoulder from "./bones/shoulder.svelte";
  import BoneCrown from "./bones/crown.svelte";
  import BonePincer from "./bones/pincer.svelte";
  import BoneSpine from "./bones/spine.svelte";
  ...
  const { layout, view } = getContext(BRIDGE);
  ...
  function onResize() {
    ...
    layout.pincer = {
      x: clamp(pincer.x, EDGE_PADDING, layout.viewport.width - EDGE_PADDING),
      y: clamp(pincer.y, EDGE_PADDING, layout.viewport.height - EDGE_PADDING),
    };
  }
  ...
  onMount(() => {
    ...
    layout.standard = {
      x: clamp(home.x * layout.viewport.width, EDGE_PADDING, layout.viewport.height - EDGE_PADDING),
