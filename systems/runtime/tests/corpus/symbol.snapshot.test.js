...
import { corpus, DRY, missing, order, persist, stable, SYMBOL_SLUGS } from "./harness.js";
...
describe("corpus snapshot · symbol · 8 across ontology", { sanitizeResources: false, sanitizeOps: false }, () => {
  let scenario;
  let canonical;
  let skip = false;
