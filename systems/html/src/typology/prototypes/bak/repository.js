...
export class Repository {
  ...
  async findOne(where = {}, options = {}) {
    let result = this.findOneLocal(where);
  ...
  add(entity) {
    const instance = entity instanceof this.entity.prototype ? entity : new this.entity.prototype(entity);
    if (this.resolve) this.resolve(instance);
    return this._merge(instance);
  }
