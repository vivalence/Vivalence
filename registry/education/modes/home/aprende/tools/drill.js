...
// due literals across all ontologies and routes each to the exercise its retention state
...
export const drill = new Vector().open(
  {
    ...
    valence:
      ...
      "ontologies, each item routed to the exercise its retention state calls for (weak or failed " +
