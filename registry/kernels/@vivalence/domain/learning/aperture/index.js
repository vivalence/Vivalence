...
export const aperture = new Aperture()
  ...
  .open("/pick/literal/byAnnotation", pick.literal.byAnnotation)
  .open("/pick/literal/byStatus", pick.literal.byStatus)
  .open("/pick/literal/byStrength", pick.literal.byStrength)
  .open("/pick/symbol/feed", pick.symbol.feed)
  .open("/pick/symbol/byStatus", pick.symbol.byStatus)
  .open("/pick/symbol/byStrength", pick.symbol.byStrength)
