...
export const daemons = [
  ...
  //     },
  //   ],
  //   // consume: {nlp: {module: "@viva/service/nlp-stanza", secrets: { key: () => paladin.secret.get("SECRET_VIVA_SERVICE_NLP_KEY") }, statics: {remote: () => new Url(paladin.env.get("VIVA_SERVICE_NLP_REMOTE")), language: "es", processors: "tokenize,mwt,pos,lemma,depparse",},},},
  // },
  // {
  //   manifest: {
  //     type: "daemon",
  ...
  //   consume: {
  //     // nlp: {module: "@viva/service/nlp-stanza", secrets: { key: () => paladin.secret.get("SECRET_VIVA_SERVICE_NLP_KEY") }, statics: {remote: () => new Url(paladin.env.get("VIVA_SERVICE_NLP_REMOTE")), language: "es", processors: "tokenize,mwt,pos,lemma,depparse",},},
  //   },
  // },
];
