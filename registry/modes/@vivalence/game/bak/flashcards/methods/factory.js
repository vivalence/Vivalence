...
export function make(literal) {
  let maker;
  if (["verb", "aux"].includes(literal.symbol.word["part-of-speech"])) maker = verbFlashcards;
  else if (["noun"].includes(literal.symbol.word["part-of-speech"])) maker = nounFlashcards;
