...
export class Migration20250923143634 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table \`Runtime\` (\`id\` text not null, \`created_at\` datetime not null, \`updated_at\` datetime not null, \`slug\` text not null, \`url\` text not null, primary key (\`id\`));`);
