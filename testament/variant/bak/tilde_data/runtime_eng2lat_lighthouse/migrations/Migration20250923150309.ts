...
export class Migration20250923150309 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table \`Runtime__temp_alter\` (\`id\` text not null, \`created_at\` datetime not null default CURRENT_TIMESTAMP, \`updated_at\` datetime not null default CURRENT_TIMESTAMP, \`slug\` text not null, \`url\` text not null, primary key (\`id\`));`);
