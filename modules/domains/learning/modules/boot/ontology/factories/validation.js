export default function validationFactory(runtime) {
  const factory = validatorFactory(runtime.ontology.constraints);
  const v = {
    unit: null,
    tag: null,
    annotation: null,
  ...
  for (const dimension of runtime.ontology.dimensions.topographical) {
    const topography = runtime.ontology.topographies.findOne(dimension);
