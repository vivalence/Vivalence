...
async function boot(runtime) {
  ...
  route("/curriculum/install", curriculum.install);
  ...
  route("/tag/install", tags.install);
  ...
  route("/unit/install", units.install);
  ...
  route("/dependency/install", dependencies.install);
