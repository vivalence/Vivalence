...
const noun = {
  ...
  dimensions: [
    ...
    { branch: ["case"], required: true }, // Every noun must show its grammatical role
    { branch: ["gender"], required: true }, // Inherent property affecting agreement
    { branch: ["number"], required: true }, // Singular/plural distinction always marked
    { branch: ["inflclass"], required: false }, // Declension pattern (1st, 2nd, 3rd, etc.)
  ],
  relations: [
    { unique: { branch: "pos" } },
    { required: { branch: "pos", leaf: "noun" } },
    { required: { branch: "case" } }, // Case marking is non-optional in Latin
    { required: { branch: "gender" } }, // Gender drives adjectival agreement
    { required: { branch: "number" } }, // Number affects verb agreement and determiners
  ],
};
