const dependencies = [
  {
    ...
    slug: "verbs-101",
    description: "Practice subject pronouns and their relationship with verb endings",
    ...
    conditions: [
      ...
      {
        name: "Indicative mood forms in use",
      ...
      tactic: {
        ...
        relations: {
          tags: {
            ...
            verbs: [{ slug: "lemma:hablar" }, { slug: "lemma:comer" }, { slug: "lemma:vivir" }],
          },
        },
        masks: {
          translations: {
            goal: `
Create simple sentences with subject pronouns and basic verb forms.
...
`,
  ...
  //   conditions: [{name: "-ar verbs mastery", scope: { tag: { slug: "lemma:hablar" } }, assertion: { jsonata: `$count($[$ in ['KNOWN','GRADUATED']]) >= 6` },}, {name: "-er verbs mastery", scope: { tag: { slug: "lemma:comer" } }, assertion: { jsonata: `$count($[$ in ['KNOWN','GRADUATED']]) >= 6` },}, {name: "-ir verbs mastery", scope: { tag: { slug: "lemma:vivir" } }, assertion: { jsonata: `$count($[$ in ['KNOWN','GRADUATED']]) >= 6` },}, {name: "Present tense mastery", scope: { tag: { slug: "tense:pres" } }, assertion: { jsonata: `$count($[$ in ['KNOWN','GRADUATED']]) >= 10` },},],
  //   itinerary: {
  //     tactic: {
  ...
  //   conditions: [{name: "Tener mastery", scope: { tag: { slug: "lemma:tener" } }, assertion: { jsonata: `$count($[$ in ['KNOWN','GRADUATED']]) >= 4` },}, {name: "Venir mastery", scope: { tag: { slug: "lemma:venir" } }, assertion: { jsonata: `$count($[$ in ['KNOWN','GRADUATED']]) >= 4` },}, {name: "Salir mastery", scope: { tag: { slug: "lemma:salir" } }, assertion: { jsonata: `$count($[$ in ['KNOWN','GRADUATED']]) >= 4` },}, {name: "e→ie changes", scope: { tag: { slug: "stem:e-ie" } }, assertion: { jsonata: `$count($[$ in ['LEARNING','KNOWN','GRADUATED']]) >= 5` },}, {name: "o→ue changes", scope: { tag: { slug: "stem:o-ue" } }, assertion: { jsonata: `$count($[$ in ['LEARNING','KNOWN','GRADUATED']]) >= 5` },},],
  //   itinerary: {
  //     tactic: {
