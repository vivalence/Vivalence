// const  ProseInstruction = {
//   "instruction": {
//     "prose": "<p>In Spanish, nouns have a gender. This means that every noun is classified as either masculine or feminine. Understanding noun gender is important because it affects how we use adjectives and articles in sentences. For example, the word <strong>\"libro\"</strong> (book) is masculine, while <strong>\"mesa\"</strong> (table) is feminine.</p>\n\n<p>Here are some examples of masculine and feminine nouns:</p>\n<ul>\n  <li><strong>Masculine:</strong> <code>el perro</code> (the dog), <code>el coche</code> (the car), <code>el niño</code> (the boy)</li>\n  <li><strong>Feminine:</strong> <code>la gata</code> (the female cat), <code>la casa</code> (the house), <code>la niña</code> (the girl)</li>\n</ul>"
//   },
//   "scope": {
//     "dependency": {
