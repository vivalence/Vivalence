...
export default async function agent(input, ctx) {
  // return [{index: 1, slug: "salve", expectedResponse: "Salve!", clue: "The Latin greeting for one person sounds like 'salve'", prompt: "In Latin, how would you say 'hello' to a single person?\n\nHint: It's a word that sounds like 'sal-vay' and ends with an 'e'.",}, {index: 2, slug: "quid_agis", expectedResponse: "Quid agis?", clue: "To ask 'how are you' in Latin, use 'quid agis'", prompt: "After greeting someone with 'Salve!', you want to ask 'How are you?' in Latin.\n\nHint: The phrase has two words. The first word 'quid' means 'what' and the second word 'agis' relates to 'doing'.",}, {index: 3, slug: "bene", expectedResponse: "Bene!", clue: "Respond positively with the Latin word 'bene'", prompt: "Someone asks you 'Quid agis?' (How are you?). How would you respond 'Well!' or 'Good!' in Latin?\n\nHint: It's a short word that sounds like 'beh-neh'.",}, {index: 4, slug: "nomen_meum", expectedResponse: "Nomen meum est...", clue: "Introduce yourself using 'nomen meum est...'", prompt: "You want to say 'My name is...' in Latin.\n\nHint: The phrase starts with 'Nomen' (name) followed by 'meum' (my) and then 'est' (is).\n\nComplete the phrase: ___ ___ ___...",}, {index: 5, slug: "salvete", expectedResponse: "Salvete!", clue: "For greeting multiple people, add 'te' to 'salve'", prompt: "You've learned 'Salve!' is 'Hello!' to one person. How would you greet multiple people in Latin?\n\nHint: Add the suffix '-te' to the singular form.",}, {index: 6, slug: "vale", expectedResponse: "Vale!", clue: "Say goodbye with 'vale', similar to 'salve'", prompt: "To end your Latin conversation with one person, how would you say 'Goodbye!'?\n\nHint: It's similar to 'salve' but starts with a 'v' and sounds like 'vah-leh'.",},];
