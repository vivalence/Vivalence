...
specimen.describe("nordic theme — flat scoped skeletons", () => {
  ...
  specimen.it(
    "provides theme/system aliases derived from skeleton 1",
    async () => {
      const ds = await buildNordic();
      specimen.expect(ds.themes.nordic.colors.theme).toBeDefined();
      specimen.expect(ds.themes.nordic.colors.theme.primary.surface)
        .toBeDefined();
      specimen.expect(ds.themes.nordic.colors.system).toBeDefined();
      specimen.expect(ds.themes.nordic.colors.system.success.surface)
        .toBeDefined();
      specimen.expect(ds.themes.nordic.colors.system.error.surface)
        .toBeDefined();
      specimen.expect(ds.themes.nordic.colors.skeleton[0].primary)
        .toBeDefined();
  ...
  specimen.it(
    "each skeleton has the 11 expected role keys + font",
    async () => {
      const ds = await buildNordic();
      const expectedKeys = [
        "surface",
  ...
  specimen.it(
    "interactive roles are {base, hover, active} triplets",
    async () => {
      const ds = await buildNordic();
  ...
  specimen.it(
    "error is a {surface, contrast, boundary} box (no states)",
    async () => {
      const ds = await buildNordic();
      const sk = ds.themes.nordic.colors.skeleton[1];
  ...
  specimen.it(
    "skeleton 0 uses DEEP[900] for surface and IRON[100] for contrast",
    async () => {
      const ds = await buildNordic();
  ...
  specimen.it(
    "skeleton 1 has primary.base = AQUA[300] = #1EBCB5 (the brand)",
    async () => {
      const ds = await buildNordic();
      const sk = ds.themes.nordic.colors.skeleton[1];
  ...
  specimen.it(
    "skeleton 1 primary.hover walks one stop lighter to AQUA[200]",
    async () => {
      const ds = await buildNordic();
      const sk = ds.themes.nordic.colors.skeleton[1];
  ...
  specimen.it(
    "skeleton 1 primary.active walks one stop darker to AQUA[400]",
    async () => {
      const ds = await buildNordic();
      const sk = ds.themes.nordic.colors.skeleton[1];
  ...
  specimen.it(
    "text ramp: primary iron[100], body iron[300], support iron[400]",
    async () => {
      const ds = await buildNordic();
  ...
  specimen.it(
    "preserves the roots and palette under colors for escape hatches",
    async () => {
      const ds = await buildNordic();
