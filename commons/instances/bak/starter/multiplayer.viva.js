...
// export const runtime = {slug: "runtime", traits: ["EMBEDDED"], statics: {serve: () => new Url(paladin.env.get("VIVA_RUNTIME_SERVE")),}, datamap: {module: "@commons/datamap/libsql", statics: {db: { file: `runtime.viva.db` },},},};
...
export const daemons = [
  ...
  //     },
  //   ],
  //   // consume: {nlp: {module: "@commons/service/nlp-stanza", secrets: { key: () => paladin.secret.get("SECRET_VIVA_SERVICE_NLP_KEY") }, statics: {remote: () => new Url(paladin.env.get("VIVA_SERVICE_NLP_REMOTE")), language: "es", processors: "tokenize,mwt,pos,lemma,depparse",},},},
  // },
  // {
  //   manifest: {
  //     type: "daemon",
  ...
  //       },
  //     },
  //     // {module: "@commons/hallucinator/elevenlabs", statics: {}, secrets: { key: () => paladin.secret.get("SECRET_VIVA_ELEVENLABS_API_KEY") },}, {module: "@commons/hallucinator/deepgram", statics: {}, secrets: { key: () => paladin.secret.get("SECRET_VIVA_DEEPGRAM_API_KEY") },},
  //   ],

  //   consume: {
  //     // nlp: {module: "@commons/service/nlp-stanza", secrets: { key: () => paladin.secret.get("SECRET_VIVA_SERVICE_NLP_KEY") }, statics: {remote: () => new Url(paladin.env.get("VIVA_SERVICE_NLP_REMOTE")), language: "es", processors: "tokenize,mwt,pos,lemma,depparse",},},
  //   },
  // },
];
