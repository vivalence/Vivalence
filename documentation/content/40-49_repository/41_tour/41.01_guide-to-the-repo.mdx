...
registry/         packages — the content: modes, services, instances
  viva/           core services (datamap, hallucinator, lighthouse, nlp) and the instances
...
The core package — services and instances:
