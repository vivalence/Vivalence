...
when_to_use: "add X to <subsystem>" · "wire up <thing>" · "write a new <primitive>" · before any cross-component dispatch · before acting on a command staged in a compact or quest.
---
