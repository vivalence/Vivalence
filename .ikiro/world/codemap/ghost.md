...
- registry access rides `vip.supply()` everywhere (`instance/clone.js:75`, `system/doctor.js:132`, `variant/clone.js:13`) — the old "mounts registry FLAT via vip.mount(scope.registry)" claim was stale; no raw mount call sites remain outside comments.
