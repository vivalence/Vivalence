...
- **kernels**: domain/learning (Literal/Symbol/Memory/Product; drivers BAYESIAN ebisu / BOOLEAN / COUNTER; status UNTOUCHED→…→GRADUATED; aperture `/pick/literal/*` + `/review/*`) · topology/{word,sentence,conjugation} · topography/english-to-brazilian (2086 literals, 1160 mp3; audit spec → [[corpus-quality-criteria]]) · topography/english-to-spanish (M1, boot pending).
