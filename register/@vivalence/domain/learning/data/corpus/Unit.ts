...
export class UnitEntity extends DataEntity {
  tags = new Collection<SymbolEntity>(this);
...
export const UnitSchema = new EntitySchema<UnitEntity, DataEntity>({
  extends: DataSchema,
  class: UnitEntity,
  tableName: "Unit",
  ...
  properties: {
    ...
    symbols: { kind: "m:n", entity: () => SymbolEntity, mappedBy: "units" },
