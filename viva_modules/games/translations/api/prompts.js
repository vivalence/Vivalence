export const EvalTranslationPrompt = {
  ...
  schema: {
    ...
    definitions: {
      translation: {
        type: "string",
        description:
          `In 3 short sentences: describe 1: the linguistic attributes of the original sentence and the provided translation. 2: argue if the user got the translation right over all. and 3: what errors where made and in what specific parts of speech. `,
      },
      token: {
        type: "string",
        description:
  ...
  template: `# TASK
Evaluate a translated sentence. The translation is from {{{language.spoken}}} to {{{language.learning}}}.
...
### TRANSLATION
original sentence: "{{{sentence.spoken}}}"
original sentence: "{{{sentence.spoken}}}"
...
export const EvalTokensPrompt = {
  ...
  schema: {
    ...
    definitions: {
      status: {
        description:
          `KNOWN indicates correct usage of PART in the translation. UNKNOWN marks incorrect usage, including spelling and missing words. NEUTRAL applies for successful alternative use. Absence of PART is UNKNOWN.`,
...
### TRANSLATION
from {{{language.spoken}}} to {{{language.learning}}}
original sentence: "{{{sentence.spoken}}}"
...
### "Unit:{{part.id}}" {{{part.spoken}}} {{{part.token}}}
{{#part.tags}}
