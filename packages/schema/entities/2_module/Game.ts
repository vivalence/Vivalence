...
// class VivaURL extends URL {#modulename: any; set modulename(value) {this.#modulename = value;} get modulename() {return this.#modulename;} toString() {return this.pathname;}}
...
export class GameEntity extends BaseModuleEntity {
  ...
  get url() {
    const url = new URL(`${this.runtime.url.href}/game/${this.slug}`);
