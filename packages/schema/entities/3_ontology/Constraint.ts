...
import { IssueEntity } from "../3_ontology/Issue.ts";
...
export class ConstraintRepository extends BaseOntologyRepository {
...
export class ConstraintEntity extends BaseOntologyEntity {
