...
export { ValenceEntity, ValenceRepository } from "./3_system/Valence.ts";
...
import { ValenceEntity, ValenceRepository } from "./3_system/Valence.ts";
...
export const repositories = { valence: ValenceRepository };
