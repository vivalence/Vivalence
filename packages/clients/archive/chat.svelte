<script>
  ...
  async function handleIntent(intent) {
    switch (intent.resolution.type) {
      case "TACTIC":
        // setup intent constrained that get passed to the buffer renderer.
        app.navigate(`/buffer/${intent.resolution.type}`, { input: intent.resolution.input });
...
<div class="chat-container">
  <div class="messages">
    {#each $chatHistory as message}
      <div
        class="message {message.role} {message.error
          ? 'error'
