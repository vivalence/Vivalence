<script>
    ...
    $: if (scope && instruction) {
        ...
        // store.update((s) => ({...s, instruction: {sentence: {spoken: "The old women", learning: "Las mujeres viejas", translation: "Las mujeres viejos"}}, input: "Las mujeres viejos", revealed: true}));
        // store.evaluate();
    }
</script>
