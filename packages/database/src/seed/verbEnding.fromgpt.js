...
import { appendToFile, FiniteTenseEnum, getEnding, MoodEnum, NonFiniteTenseEnum, PerformerEnum, Verbs } from "./lib.js";
...
const conjugate = async (verb, index) => {
  const systemMessage =
    `Provide the Spanish verb conjugation for ending extraction; no additional information or characters, no "-()/+_" ; just the end.`;
